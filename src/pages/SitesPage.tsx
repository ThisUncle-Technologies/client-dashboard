    ...
    <AppLayout title="Sites">
      ...
      {loading ? (
        ...
        <div className="flex items-center justify-center h-48 border border-dashed border-gray-200 rounded-lg">
          <p className="text-sm text-gray-400">No sites yet. Add your first one.</p>
        </div>
      ) : (
        <div className="border border-gray-100 rounded-lg overflow-hidden">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-50">
              {sites.map(site => (
                <tr key={site.id} className="bg-white hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <span className="text-[10px] uppercase tracking-widest text-gray-400">{site.integration_type}</span>
                  </td>
                  <td className="px-4 py-3">
